				    ...
				    struct x86_exception *fault)
{
	...
	/*
	 * A sad workaround for KVM's bad exception handling.  If KVM injected
	 * an exception into L2, and L2 encountered a #PF while vectoring the
	 ...
	 * most problematic (when L0 and L1 are using shadow paging).
	 *
