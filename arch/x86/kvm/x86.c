...
EXPORT_SYMBOL_GPL_FOR_KVM_INTERNAL(kvm_arch_start_assignment);

void kvm_arch_end_assignment(struct kvm *kvm)
{
	atomic_dec(&kvm->arch.assigned_device_count);
}
EXPORT_SYMBOL_GPL_FOR_KVM_INTERNAL(kvm_arch_end_assignment);

bool noinstr kvm_arch_has_assigned_device(struct kvm *kvm)
{
	return raw_atomic_read(&kvm->arch.assigned_device_count);
}
EXPORT_SYMBOL_GPL_FOR_KVM_INTERNAL(kvm_arch_has_assigned_device);
...
EXPORT_SYMBOL_GPL_FOR_KVM_INTERNAL(kvm_arch_register_noncoherent_dma);
...
EXPORT_SYMBOL_GPL_FOR_KVM_INTERNAL(kvm_arch_unregister_noncoherent_dma);
...
EXPORT_SYMBOL_GPL_FOR_KVM_INTERNAL(kvm_arch_no_poll);
