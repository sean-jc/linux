...
static struct kvm_x86_ops svm_x86_ops __initdata = {
	...
	KVM_X86_OP(decache_cr0_guest_bits),
	KVM_X86_OP(decache_cr4_guest_bits),
	KVM_X86_OP(set_cr0),
	KVM_X86_OP(set_cr4),
	KVM_X86_OP(set_efer),
	KVM_X86_OP(get_idt),
...
static struct kvm_x86_init_ops svm_init_ops __initdata = {
	KVM_X86_OP(cpu_has_kvm_support),
	KVM_X86_OP(disabled_by_bios),
	KVM_X86_OP(hardware_setup),
