...
/* Hyper-V hooks, filled at runtime. */
#define vmx_tlb_remote_flush NULL
#define vmx_tlb_remote_flush_with_range NULL
#define vmx_enable_direct_tlbflush NULL

/* Confidential VM hooks, not yet supported. */
#define vmx_mem_enc_op NULL
#define vmx_mem_enc_reg_region NULL
#define vmx_mem_enc_unreg_region NULL
