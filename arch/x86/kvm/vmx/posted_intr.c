		       ...
		       struct kvm_kernel_irq_routing_entry *new)
{
	...
	hlist_for_each_entry(e, &irq_rt->map[guest_irq], link) {
		...
		/*
		 * The loop makes it hard to see, but there's only a single
		 * host IRQ to configured, and KVM allows at most one MSI per
		 * GSI.  Said host IRQ is being configured to post t
		 */
